...
* @history:
*/
public class ScCollection extends ABaseDO {
    ...
    public Date getScDatetime() {
        return scDatetime;
    }

    public void setScDatetime(Date scDatetime) {
        this.scDatetime = scDatetime;
    }
